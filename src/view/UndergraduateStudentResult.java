...
import controller.UndergraduateStudentResultController;
 ...
 * @author manji
 */
public class UndergraduateStudentResult extends javax.swing.JFrame {

 
    public UndergraduateStudentResult() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel7.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Undergraduatestudent Result ", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 18), new java.awt.Color(25, 88, 157))); // NOI18N
 ...
 Dashborad dashborad=new Dashborad();
    ...
    private void submitbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitbtnActionPerformed
        ...
        try {
            ...
            UndergraduateStudentResultModel undergraduateStudentResultModel=new UndergraduateStudentResultModel(subjectCode, attempt, year, indexNo, marks, grade, attemptYearIndexNo);
            //System.out.println(courseName.length());
            int res = UndergraduateStudentResultController.addResult(undergraduateStudentResultModel);
            if (res > 0) {
                JOptionPane.showMessageDialog(this, "Added Success");
            }
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(UndergraduateStudentResult.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void editbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editbtnActionPerformed
        ...
        try {
            int res=UndergraduateStudentResultController.editResult(undergraduateStudentResultModel);
            if(res>0){
    ...
    private void searchbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchbtnActionPerformed
       String attempt=attempttxt.getText();
        ...
        System.out.print(id);
         ...
         UndergraduateStudentResultModel undergraduateStudentResultModel;
        try {
            undergraduateStudentResultModel = UndergraduateStudentResultController.searchResult(id);
        
            if (undergraduateStudentResultModel != null) {
                subjectCodetxt.setText(undergraduateStudentResultModel.getSubjectCode());
            attempttxt.setText(undergraduateStudentResultModel.getAttempt());
            yeartxt.setText(undergraduateStudentResultModel.getYear());
            indexNotxt.setText(undergraduateStudentResultModel.getIndexNo());
            markstxt.setText(Integer.toString(undergraduateStudentResultModel.getMarks()));
            //gradetxt.setText(postgraduateStudentResultModel.getGrade());
            gradetxt.setText(undergraduateStudentResultModel.getGrade());
    ...
    private void datetebtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_datetebtnActionPerformed
        ...
        int res = 0;
        try {
            res = UndergraduateStudentResultController.deleteResult(id);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(UndergraduateStudentResult.class.getName()).log(Level.SEVERE, null, ex);
        } catch (SQLException ex) {
            Logger.getLogger(UndergraduateStudentResult.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UndergraduateStudentResult().setVisible(true);
            }
        });
    }
