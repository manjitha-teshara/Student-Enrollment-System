...
public class AllSubjectView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        subject_1Query2 = java.beans.Beans.isDesignTime() ? null : nsbmsystemPUEntityManager.createQuery("SELECT s FROM Subject_1 s");
        subject_1List2 = java.beans.Beans.isDesignTime() ? java.util.Collections.emptyList() : subject_1Query2.getResultList();
        subject_1Query3 = java.beans.Beans.isDesignTime() ? null : nsbmsystemPUEntityManager.createQuery("SELECT s FROM Subject_1 s");
        subject_1List3 = java.beans.Beans.isDesignTime() ? java.util.Collections.emptyList() : subject_1Query3.getResultList();
        ...
        jPanel7.add(searchbtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 400, 100, -1));

        jTable1.setBackground(new java.awt.Color(242, 255, 204));
        jTable1.setGridColor(new java.awt.Color(242, 255, 204));

        org.jdesktop.swingbinding.JTableBinding jTableBinding = org.jdesktop.swingbinding.SwingBindings.createJTableBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, subject_1List3, jTable1);
        ...
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${subjectName}"));
        columnBinding.setColumnName("Subject Name");
        columnBinding.setColumnClass(String.class);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${superviser}"));
        columnBinding.setColumnName("Superviser");
        columnBinding.setColumnClass(String.class);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${instroucter1}"));
        columnBinding.setColumnName("Instroucter1");
        columnBinding.setColumnClass(String.class);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${instroucter2}"));
        columnBinding.setColumnName("Instroucter2");
        columnBinding.setColumnClass(String.class);
        ...
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${numberOfAssignment}"));
        columnBinding.setColumnName("Number Of Assignment");
        columnBinding.setColumnClass(Integer.class);
        bindingGroup.addBinding(jTableBinding);
        jTableBinding.bind();
        jScrollPane1.setViewportView(jTable1);

        jPanel7.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 30, 800, 180));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AllSubjectView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private java.util.List<view.Subject_1> subject_1List2;
    private java.util.List<view.Subject_1> subject_1List3;
    private javax.persistence.Query subject_1Query;
    private javax.persistence.Query subject_1Query1;
    private javax.persistence.Query subject_1Query2;
    private javax.persistence.Query subject_1Query3;
